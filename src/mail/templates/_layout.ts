...
const LEGAL_FOOTER = 'AllServices — ALS Marketing UK Ltd — Unit X, London, UK';
...
export function renderHtmlLayout(bodyHtml: string, options: LayoutOptions): string {
  return [
    ...
    '.cta{display:inline-block;margin:20px 0;padding:12px 20px;background:#0b1221;color:#ffffff;text-decoration:none;border-radius:8px;font-weight:600}',
